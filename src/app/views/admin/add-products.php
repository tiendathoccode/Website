...
<div class="container-fluid">
    <div class="row min-vh-100">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-5 py-4 main-content">
            <form action="/index.php?page=admin_product_store" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-8">
                        <div class="card border-0 shadow-sm p-4 mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="product_name" class="form-control form-control-custom" placeholder="Ví dụ: Aurum Solitaire Necklace" required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label form-label-custom">MÔ TẢ SẢN PHẨM</label>
                                <div class="rich-text-editor border rounded">
                                    <textarea name="description" class="form-control border-0 shadow-none p-3 font-xs text-muted" rows="6" placeholder="Mô tả chất liệu, kiểu dáng và điểm nổi bật của sản phẩm..."></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card border-0 shadow-sm p-4">
                            ...
                            <div class="upload-zone border-dashed rounded text-center p-5 bg-light-custom position-relative">
                                <input type="file" name="main_image" class="position-absolute w-100 h-100 top-0 start-0 opacity-0 cursor-pointer" accept="image/jpeg,image/png,image/webp" required>
                                <div class="upload-icon mb-3">
                                    <i class="bi bi-cloud-arrow-up fs-2 text-gold"></i>
                                </div>
                                <h6 class="mb-2 font-xs fw-bold">Chọn ảnh đại diện sản phẩm</h6>
                                <p class="text-muted font-xs mb-3">JPG, PNG hoặc WEBP</p>
                    ...
                    <div class="col-lg-4">
                        <div class="card border-0 shadow-sm p-4 mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="sku" class="form-control form-control-custom font-monospace" placeholder="Ví dụ: AUR-RING-001" required>
                            </div>

                            <div class="mb-4">
                                <label class="form-label form-label-custom">GIÁ BÁN (VNĐ)</label>
                                <input type="number" name="price" min="0" step="1000" class="form-control form-control-custom" placeholder="0" required>
                            </div>

                            <div class="mb-4">
                                <label class="form-label form-label-custom">GIÁ KHUYẾN MÃI (VNĐ)</label>
                                <input type="number" name="sale_price" min="0" step="1000" class="form-control form-control-custom" placeholder="0">
                            </div>

                            <div class="mb-2">
                                <label class="form-label form-label-custom">SỐ LƯỢNG TỒN KHO</label>
                                <input type="number" name="stock_quantity" min="0" class="form-control form-control-custom" placeholder="0" required>
                            </div>
                        </div>
                        ...
                        <div class="card border-0 shadow-sm p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="category_id" class="form-select form-control-custom font-xs text-muted" required>
                                    ...
                                    <?php foreach ($categories as $category): ?>
                                        <?php if (($category["status"] ?? "show") === "show"): ?>
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" name="material" class="form-control form-control-custom" placeholder="Ví dụ: Vàng 18K">
                            </div>
                        </div>
                    </div>
                </div>
